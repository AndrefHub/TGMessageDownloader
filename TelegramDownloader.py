...
class MessageDownloader:
    ...
    async def _process_message(self, message):
        ...
        if not check_message_text_for_hashtags(message.text, self.hashtags):
            if group_id:
    ...
    async def __send_messages_cycle(self):
        ...
        await self.__send_prepared_messages(
            ...
            self.convert_message_to_json_generator(convert_message_to_data),
        )
        ...
        await self.__send_prepared_messages(
            ...
            self.convert_message_to_json_generator(convert_group_to_data),
        )
    ...
    async def get_history(self, channel):
        ...
        create_output_directories(self.image_path, self.video_path)
        ...
        write_messages_to_file(self.parsed_messages, f"{channel}.json")
